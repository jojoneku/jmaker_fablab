  ...
  Future<void> signIn(
    ...
    if (isOfflineMode) {
      ...
      if (isUserDataAvailable) {
        if (email == userCredentials.get('email') && password == userCredentials.get('pass')) {
          if (userCredentials.get('isAccountVerified') == true) {
            ...
            SnackBarController.showSnackBarWithActionButton(
              context,
              text: 'Account not verified. Please check your email for verification and try logging in with internet access.',
        ...
        return SnackBarController.showSnackBar(context, 'Please check your internet connection.');
      }
    }
