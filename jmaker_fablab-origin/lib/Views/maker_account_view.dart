...
class _MakerAccountViewState extends State<MakerAccountView> {
  ...
  final List<String> minority = ['Youth (15-30)', 'Adult (30-59)', 'Senior Citizen(60+)','PWD' ];
  final List<String> userType = ['MSMEs', 'Start-Up', 'Government Office/NGO/Org'];
  ...
  void initState() {
    ...
    selectedMinority = widget.userData?.minority ?? 'Youth (15-30)';
    selectedUserType = widget.userData?.userType ?? 'MSMEs';
